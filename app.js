  ...
  if (news.length === 0) {
    ...
    noDataDiv.innerHTML = `
      <div class="col text-center noDivBorder">
        <img class="noDivImg" src="./img/Icon.png" class="card-img-top" style="width:100px; height:100px" alt="No Data">
    ...
    news.forEach((newss) => {
      ...
      newsDiv.innerHTML = `
        <div class="card">
          ...
          ? '<p><i style="background-color: #0000; color: blue" class="fa-regular fa-circle-check"></i></p>'
          : ""
        }
                </div>
